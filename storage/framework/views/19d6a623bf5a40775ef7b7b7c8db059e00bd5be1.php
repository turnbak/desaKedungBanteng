<div class="modal fade in" id="impor-surat">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open(route('surat_master.impor'), 'id="validasi" enctype="multipart/form-data"'); ?>
...
<?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/pengaturan_surat/impor.blade.php ENDPATH**/ ?>