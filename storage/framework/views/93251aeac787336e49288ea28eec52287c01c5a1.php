...
<script>
  $(document).ready(function () {
    ...
    var TableData = $('#tabeldata').DataTable({
      ...
      serverSide: true,
      ajax: {
        url: "<?php echo e(route('kehadiran_rekapitulasi.datatables')); ?>",
        data: function(req) {
    ...
    $(document).on('click', '#excel', function(e) {
        $.ajax({
            url: "<?php echo e(route('kehadiran_rekapitulasi.ekspor')); ?>",
            type:"GET",
            data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/rekapitulasi/index.blade.php ENDPATH**/ ?>