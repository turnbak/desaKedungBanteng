...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="info-sync">
        ...
        <ol style="padding: 0 0 0 25px;">
            ...
            <li>
                ...
                (sumber <a id="rtm_clear" href="<?php echo e(route('rtm/clear')); ?>">Kependudukan/Rumah Tangga</a> hanya yang
                berstatus
                masih hidup)
            </li>
            <li>
    ...
    <div class="tab-pane" id="dtks-info-program-keluarga">
        <?php echo form_open(route('dtks.savePengaturan') . '/2', 'class="form-program" id="form-program-keluarga"'); ?>
    ...
    <div class="tab-pane" id="dtks-info-program-anggota">
        <?php echo form_open(route('dtks.savePengaturan') . '/2', 'class="form-program" id="form-program-anggota"'); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.form-program').on('submit', function(ev) {
            ...
            //     });
            // });
            ajax_save_dtks("<?php echo e(route('dtks.savePengaturan') . '/' . 2); ?>", form);
        });
    });
</script>
<?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/dtks/2/info.blade.php ENDPATH**/ ?>