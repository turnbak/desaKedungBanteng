...
<script>
  ...
  $('#btnSetuju').on('click', function() {
    var link = "<?php echo e(route($aksi_ya)); ?>";
  ...
  $('#btnTidak').on('click', function() {
    var link = "<?php echo e(route($aksi_tidak)); ?>";
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/layouts/components/pengumuman.blade.php ENDPATH**/ ?>