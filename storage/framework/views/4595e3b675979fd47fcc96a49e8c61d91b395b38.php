...
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <?php echo form_open(route('status_desa'), 'class="form-inline" id="mainform" name="mainform"'); ?>
            ...
            <a class="btn btn-social btn-success btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                <?php echo cek_koneksi_internet() == false || is_null($idm->error_msg) ? 'disabled title="Perangkat tidak terhubung dengan jaringan"' : 'href="' . route('status_desa.perbarui_idm', $tahun) . '"'; ?>><i class="fa fa-refresh"></i>Perbarui</a>
            <?php if(empty($idm->error_msg)): ?>
                <a class="btn btn-social btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                    href="<?php echo e(route('status_desa.simpan', $tahun)); ?>"><i class="fa fa-check-circle"></i>Simpan</a>
            <?php endif; ?>
            </form>
        </div>
        <div class="box-body">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $idm->ROW; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="<?php echo e(empty($data->NO) && (print 'judul')); ?> ">
                                            ...
                                            <td><?php echo e($data->SKOR[INDIKATOR['IKS 2020']]); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/status_desa/idm.blade.php ENDPATH**/ ?>