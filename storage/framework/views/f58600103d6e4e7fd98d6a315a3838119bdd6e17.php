...
<script>
  $(document).ready(function () {
    var TableData = $('#tabeldata').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: "<?php echo e(route('kehadiran_jam_kerja.datatables')); ?>",
      columns: [
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/jam_kerja/index.blade.php ENDPATH**/ ?>