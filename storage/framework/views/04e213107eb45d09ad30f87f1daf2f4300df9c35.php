<div class="modal fade in" id="pengaturan-bantuan">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open(route('setting.new_update'), 'id="main_bantuan"'); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/home/bantuan.blade.php ENDPATH**/ ?>