    ...
    <div class="box box-info">
        <?php if(can('u')): ?>
            <div class="box-header with-border">
                <a href="<?php echo e(route('identitas_desa.form')); ?>"
                    ...
                    title="Ubah Data <?php echo e(ucwords($setting->sebutan_desa)); ?>"><i class="fa fa-edit"></i> Ubah Data
                    <?php echo e(ucwords($setting->sebutan_desa)); ?></a>
                <a href="<?php echo e(route('identitas_desa.maps.kantor')); ?>"
                    class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                    title="Lokasi Kantor <?php echo e(ucwords($setting->sebutan_desa)); ?>"><i class='fa fa-map-marker'></i> Lokasi
                    Kantor <?php echo e(ucwords($setting->sebutan_desa)); ?></a>
                <a href="<?php echo e(route('identitas_desa.maps.wilayah')); ?>"
                    class="btn btn-social btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                    title="Peta Wilayah <?php echo e(ucwords($setting->sebutan_desa)); ?>"><i class='fa fa-map'></i> Peta Wilayah
                    <?php echo e(ucwords($setting->sebutan_desa)); ?></a>
            </div>
        <?php endif; ?>
        <div class="box-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover tabel-rincian">
                    <tbody>
                        ...
                        <tr>
                            <td>Telpon <?php echo e(ucwords($setting->sebutan_desa)); ?></td>
                            <td>:</td>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/identitas_desa/index.blade.php ENDPATH**/ ?>