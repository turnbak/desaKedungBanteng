...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('identitas_desa')); ?>"><?php echo e(SebutanDesa('Identitas [Desa]')); ?></a></li>
        ...
        <div class="col-md-3">
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <img class="profile-user-img img-responsive img-circle" src="<?php echo e(gambar_desa($main->path_logo)); ?>"
                        alt="Logo">
                    <br />
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input type="hidden" name="old_logo" value="<?php echo e($main->logo); ?>">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <img class="img-responsive" src="<?php echo e(gambar_desa($main->path_kantor_desa, true)); ?>"
                        alt="Kantor <?php echo e(ucwords($setting->sebutan_desa)); ?>">
                    <br />
                    ...
                    <p class="text-muted text-center text-red">(Kosongkan, jika kantor
                        <?php echo e(ucwords($setting->sebutan_desa)); ?> tidak berubah)</p>
                    <br />
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control" id="file_path2">
                        <input type="file" class="hidden" id="file2" name="kantor_desa"
                            accept=".gif,.jpg,.jpeg,.png">
                        <input type="hidden" name="old_kantor_desa" value="<?php echo e($main->kantor_desa); ?>">
                        <span class="input-group-btn">
        ...
        <div class="col-md-9">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <a href="<?php echo e(route('identitas_desa')); ?>"
                        ...
                        title="Kembali Ke Data <?php echo e(ucwords($setting->sebutan_desa)); ?>"><i
                        ...
                        <div class="col-sm-8">
                            <?php if(cek_koneksi_internet()): ?>
                                <select id="pilih_desa" name="pilih_desa" class="form-control input-sm select-nama-desa"
                                    ...
                                    data-tracker='<?php echo e(config_item('server_pantau')); ?>' style="display: none;"></select>
                            <?php endif; ?>
                            <input type="hidden" id="nama_desa" class="form-control input-sm nama_desa required"
                                minlength="3" maxlength="50" name="nama_desa" value="<?php echo e($main->nama_desa); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input readonly id="kode_desa" name="kode_desa"
                                class="form-control input-sm <?php echo e(jecho(cek_koneksi_internet(), false, 'bilangan')); ?> required"
                                <?php echo e(jecho(cek_koneksi_internet(), false, 'minlength="10" maxlength="10"')); ?> type="text"
                                onkeyup="tampil_kode_desa()" placeholder="Kode <?php echo e(ucwords($setting->sebutan_desa)); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control input-sm" type="text"
                                placeholder="NIP <?php echo e(ucwords(setting('sebutan_kepala_desa'))); ?>"
                                value="<?php echo e($main->nama_kepala_desa); ?>" readonly />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control input-sm" type="text"
                                placeholder="NIP <?php echo e(ucwords(setting('sebutan_kepala_desa'))); ?>"
                                value="<?php echo e($main->nip_kepala_desa); ?>" readonly />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea id="alamat_kantor" name="alamat_kantor" class="form-control input-sm alamat required" maxlength="100"
                                placeholder="Alamat Kantor <?php echo e(ucwords($setting->sebutan_desa)); ?>" rows="3" style="resize:none;"><?php echo e($main->alamat_kantor); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="email_desa" name="email_desa" class="form-control input-sm email" maxlength="50"
                                type="text" placeholder="E-Mail <?php echo e(ucwords($setting->sebutan_desa)); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="telepon" name="telepon" class="form-control input-sm bilangan" type="text"
                                maxlength="15" placeholder="Telpon <?php echo e(ucwords($setting->sebutan_desa)); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="website" name="website" class="form-control input-sm url" maxlength="50"
                                type="text" placeholder="Website <?php echo e(ucwords($setting->sebutan_desa)); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input id="nip_kepala_camat" name="nip_kepala_camat" class="form-control input-sm nomor_sk"
                                maxlength="50" type="text" placeholder="NIP <?php echo e(ucwords($setting->sebutan_camat)); ?>"
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/identitas_desa/form.blade.php ENDPATH**/ ?>