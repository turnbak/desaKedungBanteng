    ...
    <?php else: ?>
        <div class="box box-info">
            <div class="box-header with-border">
                <?php if(can('u')): ?>
                    <a href="<?php echo e(route('anjungan.form')); ?>"
                ...
                <?php if(can('h')): ?>
                    <a href="#confirm-delete" title="Hapus Data"
                        onclick="deleteAllBox('mainform', '<?php echo e(route('anjungan.delete')); ?>')"
    ...
    <script>
        $(document).ready(function() {
            var TableData = $('#tabeldata').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('anjungan.datatables')); ?>",
                columns: [{
                        data: 'ceklist',
                        class: 'padat',
                        searchable: false,
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/anjungan/index.blade.php ENDPATH**/ ?>