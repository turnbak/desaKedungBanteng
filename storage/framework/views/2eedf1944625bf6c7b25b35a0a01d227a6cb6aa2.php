...
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <a href="<?php echo e(route('penduduk')); ?>"
                                ...
                                <ol>
                                    ...
                                    <li>Data yang dibutuhkan untuk Impor dengan memenuhi urutan format dan aturan data pada tautan
                                        ...
                                        <div class="timeline-footer col-sm-12">
                                            <a href="<?php echo e(asset('import/FormatImporExcel.xlsm')); ?>"
                                            ...
                                            <a href="<?php echo e(asset('import/contoh_penduduk.xlsx')); ?>"
                                                class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block margin"
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/penduduk/impor.blade.php ENDPATH**/ ?>