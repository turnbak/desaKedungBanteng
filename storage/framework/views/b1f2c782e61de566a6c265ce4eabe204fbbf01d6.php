<?php if($saas->count() != 0 && $saas->first()->sisa_aktif < 21): ?>
<div class="row">
  <div class='col-md-12'>
    <div class="callout callout-warning">
      ...
      <p align="justify">
        ...
        <br>
        Ini adalah pengingat layanan Saas akan segera berakhir dalam waktu <?php echo e($saas->first()->sisa_aktif); ?> hari
        <br> 
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\test1\resources\views/admin/home/saas.blade.php ENDPATH**/ ?>